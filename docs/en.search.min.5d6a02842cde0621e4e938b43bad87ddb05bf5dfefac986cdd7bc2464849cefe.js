...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.5904e077e7b4e509df0b87d08647a7b96c4589ef85727dd43ba1a4c522e9cde5.js',function(){input.required=false;search();});}
