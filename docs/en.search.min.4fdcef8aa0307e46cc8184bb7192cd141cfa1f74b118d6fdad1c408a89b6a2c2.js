...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.0050a8eb6e2c5062e1a9fa824c4bbba27565533f055a6821e7fe699093e5ca0e.js',function(){input.required=false;search();});}
