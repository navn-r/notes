...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.935ef9aef1536280609b60e8ece2e64c87a58f7cf455afaf04d9199c14f1cdba.js',function(){input.required=false;search();});}
