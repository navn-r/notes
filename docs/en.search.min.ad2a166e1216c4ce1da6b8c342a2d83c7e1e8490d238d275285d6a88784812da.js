...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.9900e0d7d2b21dc679832795046865a2fde836f5b2499737f00c72e8a35177db.js',function(){input.required=false;search();});}
