...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.12774a89e6c3e95db396508259415ebc2b1d11ed97f5d0d72f105bf24c357f48.js',function(){input.required=false;search();});}
