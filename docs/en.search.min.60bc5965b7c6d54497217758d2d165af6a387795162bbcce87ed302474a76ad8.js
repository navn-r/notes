...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.3eb3ab7dbceb3b27b42e20d6e2951530a32ed2e6b780d6c679cf5e713d6f434e.js',function(){input.required=false;search();});}
