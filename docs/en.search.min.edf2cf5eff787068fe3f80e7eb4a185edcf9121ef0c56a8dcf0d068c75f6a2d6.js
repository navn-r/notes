...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.6534a19695f491ea26c24585a8e71fffc46c69a9c5d34ec8b2be35b9b1d85aa8.js',function(){input.required=false;search();});}
