...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.86ec7a2620350db9fec16a8a272cd98be66e911010a5a3556018f56a454f7800.js',function(){input.required=false;search();});}
