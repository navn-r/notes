...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.404a4d3682740a94650105f9408383fc55de431a2c862c499e81e672ec6d62b7.js',function(){input.required=false;search();});}
