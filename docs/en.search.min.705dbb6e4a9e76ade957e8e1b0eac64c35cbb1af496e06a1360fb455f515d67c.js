...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.eb6fa311a0a47518ce3bac9336f53ec3beeed67951759f3355d5162ee27cd4bb.js',function(){input.required=false;search();});}
