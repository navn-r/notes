...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.b7efd830f608e13d34bcc930055faa7a767903c70419a6b0fb99f2e95d1317a6.js',function(){input.required=false;search();});}
