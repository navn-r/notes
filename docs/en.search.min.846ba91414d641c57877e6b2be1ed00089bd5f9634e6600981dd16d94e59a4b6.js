...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.0ab9b198ca02d54f0244ded8b9d3ac5126e44a2ce84bcbfb347b9574643c718d.js',function(){input.required=false;search();});}
