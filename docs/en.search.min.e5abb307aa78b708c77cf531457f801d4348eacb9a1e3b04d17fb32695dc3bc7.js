...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.1ce9db0b6d5a8560321c5bfaba3efb6b9d7f2d3acaa6c16130796e7ecefb5562.js',function(){input.required=false;search();});}
