...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.899399533777cb798919aeb757e0843bd16d50c4fed59e82c24b168aea9ab7f5.js',function(){input.required=false;search();});}
