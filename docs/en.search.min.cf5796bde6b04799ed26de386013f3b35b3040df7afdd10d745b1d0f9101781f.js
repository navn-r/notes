...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.9559ca234fcfe2b8df8bcb4e0cf29d129853e495bae722cc4bb8a2794039205e.js',function(){input.required=false;search();});}
