...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.d9b425272035aa8255774df86e47dc267206b83ae9ce01d38f3572e88e5bd0ec.js',function(){input.required=false;search();});}
