...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.37e0d0ec7f5470150db2c02128ed3cbb721567b44f3d6f586df88fa3dde69ddf.js',function(){input.required=false;search();});}
