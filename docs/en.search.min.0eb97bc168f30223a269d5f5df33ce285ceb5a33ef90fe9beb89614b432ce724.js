...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.540fdfcfd91e28c1d6b7fd3dc8824a50ba09d3b95679d990d7e2c86bb594791c.js',function(){input.required=false;search();});}
