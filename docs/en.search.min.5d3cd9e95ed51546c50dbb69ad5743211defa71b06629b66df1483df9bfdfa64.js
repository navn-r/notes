...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.62c18e36efdb92166fe5968aa6ead325bc55000be0cad729c5451cb156bd06f3.js',function(){input.required=false;search();});}
