...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.8698dea899af474dcf7f25e105da8b90aa79c5be2230c5e5d3dcd108d469249c.js',function(){input.required=false;search();});}
