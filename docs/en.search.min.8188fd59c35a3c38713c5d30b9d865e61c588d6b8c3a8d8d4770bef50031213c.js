...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.df59c1935eeac67215cfc6d6d3c7e330074a3eb2a3535695d70e583411868732.js',function(){input.required=false;search();});}
